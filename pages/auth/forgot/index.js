                ...
                <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)' }}>
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            ...
                            <span className="text-600 font-medium">Please enter your email to search for your account.</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex align-items-center text-center justify-content-center mb-5 gap-5">
                                ...
                                <Button label="Cancel" className="w-full p-3 text-xl p-button-secondary" onClick={() => router.push('/')}></Button>
                                <Button label="Search" className="w-full p-3 text-xl" onClick={() => router.push('/auth/otp')}></Button>
                            </div>
                        </div>
                    </div>
                </div>
